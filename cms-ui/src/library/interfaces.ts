...
export interface OrderData { _id: string, userId: string, status: 'Processing' | 'Confirmed' | 'Packed' | 'Shipping' | 'Delivered' | 'Cancelled', paymentMethod?: 'COD' | 'eSewa', paymentStatus?: 'Pending'|'Paid'|'Failed'|'Refunded', trackingCode?: string, adminNote?: string, createdAt: string, updatedAt: string, __v: number, user?: UserData, details?: DetailData[], payment?: PaymentData | null, customerAddress?: string, customerPhone?: string }
