...
export const List: React.FC = () => {
    ...
    useEffect(() => { load() }, [])
    const filtered = useMemo(() => !filter ? orders : orders.filter(o => o.user?.name?.toLowerCase().includes(filter.toLowerCase()) || o._id.toLowerCase().includes(filter.toLowerCase())), [orders, filter])
